...
class HybridOfficialScraper(AbstractScraper):
    ...
    def scrape(self) -> List[Dict[str, str]]:
        base_data = [
            ...
            # 팝업스토어 & 전시/행사 (전국 주요 유통망 & 전국구 팝업 플랫폼)
            {"target": "팝플리 (POPPLY)", "title": "전국 주요 팝업스토어 지도 & 브랜드 일정 (서울/경기/부산/대구/대전/광주)", "details": "https://popply.co.kr", "category": "팝업스토어 & 전시/행사"},
            {"target": "팝가 (POPGA)", "title": "전국 팝업스토어 & 브랜드 스토어 제휴 소식", "details": "https://popga.co.kr", "category": "팝업스토어 & 전시/행사"},
            {"target": "더현대 팝업스토어", "title": "더현대 서울/대구/판교/신촌/무역센터 대형 팝업스토어 현황", "details": "https://www.ehyundai.com", "category": "팝업스토어 & 전시/행사"},
            {"target": "신세계백화점 팝업스토어", "title": "신세계 강남/센텀시티(부산)/대구/대전/본점 팝업스토어 소식", "details": "https://www.shinsegae.com", "category": "팝업스토어 & 전시/행사"},
            {"target": "롯데백화점 팝업스토어", "title": "롯데월드몰/명동본점/부산본점(서면)/수원/인천 팝업스토어", "details": "https://www.lotteshopping.com", "category": "팝업스토어 & 전시/행사"},
            {"target": "스타필드 팝업스토어", "title": "스타필드 Suwon/Hanam/Goyang/Anseong 브랜드 대형 팝업", "details": "https://www.starfield.co.kr", "category": "팝업스토어 & 전시/행사"},
            {"target": "AK플라자 팝업스토어", "title": "AK플라자 홍대/수원/분당서현 팝업스토어 & 문화행사", "details": "https://www.akplaza.com", "category": "팝업스토어 & 전시/행사"},
